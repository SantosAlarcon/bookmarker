...
const BookmarkItemComponent = (props: BICProps) => {
	return (
		<div className={styles.bookmark__item__container} title={props.children.description}>
			<Link className={styles.bookmark__item__link} href={props.children.url} target="_blank">
				...
				<div className={styles.bookmark__item__favorite}>
