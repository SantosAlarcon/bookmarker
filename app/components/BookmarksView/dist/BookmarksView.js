...
var BookmarksView = function () {
    ...
    var bookmarksList = bookmarksStore_1.bookmarksStore(function (state) {
        return state.bookmarksList;
    });
    var allBookmarksList = bookmarksStore_1.bookmarksStore(function (state) {
        return state.allBookmarksList;
    });
    // Get the filter from the filter store
    var filter = filterStore_1.filterStore(function (state) {
        return state.filter;
    });
    // Get the session from the store because it already has the session information fetched in the auth button.
    var session = authStore_1.authStore(function (state) {
    ...
    var _a = react_1.useState(false),
        loading = _a[0],
        setLoading = _a[1];
    var _b = react_1.useState(__spreadArrays(bookmarksList)),
        filteredList = _b[0],
        setFilteredList = _b[1];
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                return [
                                    4 /*yield*/,
                                    updateBookmarkList_1.updateBookmarkList(),
                                ];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
    ...
    react_1.useEffect(
        function () {
            if (filter === "" || filter === undefined) {
                ...
                // @ts-ignore
                setFilteredList(
                    __spreadArrays(allBookmarksList).filter(function (item) {
                        var _a, _b;
                        return (
                            ((_a = item.bookmark_title) === null ||
                            _a === void 0
                                ? void 0
                                : _a.toLowerCase().includes(filter)) ||
                            ((_b = item.folder_title) === null || _b === void 0
                                ? void 0
                                : _b.toLowerCase().includes(filter))
                        );
                    }),
                );
            }
    ...
    return React.createElement(
        React.Fragment,
        null,
        React.createElement(EditBookmarkDialog_1["default"], {
            title: t("edit-bookmark-title"),
        }),
        React.createElement(EditFolderDialog_1["default"], {
            title: t("edit-folder-title"),
        }),
        React.createElement(ConfirmDeleteDialog_1["default"], {
            title: t("delete-item"),
        }),
        React.createElement(
            "main",
                  ...
                  ? // First render the root folders and its children
                    React.createElement(
                        framer_motion_1.motion.ul,
                        {
                            ...
                            className:
                                BookmarksView_module_scss_1["default"]
                                    .bookmarks__view__list,
                        },
                        filteredList === null || filteredList === void 0
                            ? void 0
