			...
			<header className={styles.header__container}>
				<div className={styles.header__upper}>
					<div className={styles.header__logo} onClick={() => router.push("/")}>
						<Image src="/BookmarkerLogo.svg" width="128" height="128" alt="Logo" priority className={styles.header__logo_img} />
					</div>
					<div className={styles.header__links}>
						<div className={styles.header__links__new__boomark}>
							...
							>
								...
								/>
								<Image width={32} height={32} src="/icons/add-bookmark-icon.svg" alt="New bookmark icon" priority />
							</button>
						</div>
						<div className={styles.header__links__new__folder}>
							...
							>
								...
								/>
								<Image width={32} height={32} src="/icons/add-folder-icon.svg" alt="New folder icon" priority />
							</button>
						</div>
						<AuthButton />
					</div>
